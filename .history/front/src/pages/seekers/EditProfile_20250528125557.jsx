            ...
            <div className="row">
              <div className="col-md-8 offset-md-2">
                  ...
                  <div className="my-2">
                     ...
                     <input type="text" name="name" onChange={updateFrm.handleChange} className="form-control"/>
                  </div>
                  <div className="my-2">
                     <label>USERNAME / EMAIL</label>
                     <input type="text" name="email" onChange={updateFrm.handleChange} className="form-control"/>
                  </div>
                  <div className="my-2">
                     <label>CONTACT NUMBER :-</label>
                     <input type="text" name="contact" onChange={updateFrm.handleChange} className="form-control"/>
                  </div>
                  <div className="my-2">
                     <label>ADDRESS </label>
                     <textarea name="address" onChange={updateFrm.handleChange} className="form-control"></textarea>
                  </div>
                  <div className="my-2">
                     <label>GENDER </label>
                     <br/>
                     <br/>
                     MALE <input type="radio" name="gender" value="male" onChange={updateFrm.handleChange} />	&nbsp; 	&nbsp;
                    &nbsp;FEMALE <input type="radio" name="gender" value="female" onChange={updateFrm.handleChange}/>
                  </div>
                  <div className="my-4">
