            ...
            <div className="row">
              <div className="col-md-8 offset-md-2">
                  ...
                  <div className="my-2">
                     ...
                     <input type="text" value={updateFrm.values.email} name="email" onChange={updateFrm.handleChange} className="form-control"/>
                  </div>
                  <div className="my-2">
                  ...
                  <div className="my-2">
                     ...
                     <br/>
                     <br/>
                     MALE <input type="radio" name="gender" value={updateFrm.values.gender} onChange={updateFrm.handleChange} />	&nbsp; 	&nbsp;
                    &nbsp;FEMALE <input type="radio" name="gender"  value={updateFrm.values.gender} onChange={updateFrm.handleChange}/>
                  </div>
                  <div className="my-4">
