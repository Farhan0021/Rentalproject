...
const EditProfile = () => {
  ...
  // in the form of formik the initial values must be define by making state
        ...
        <div className="col-md-3">
          ...
          <div className='alert alert-secondary'>
            ...
            <ul className='nav flex-column'>
              ...
              <li className='nav-item'>
                <NavLink to='/seeker/update-password' className='nav-link text-bg.green'>Update Password  <i class="fa fa-angle-right" aria-hidden="true"></i></NavLink>
              </li>
              <li className='nav-item'>
