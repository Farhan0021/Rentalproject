...
let [showMsg, setShowMsg] = useState(false);   // 2nd Modal ke liye
let [btnDisable, setBtnDisable] = useState(true); // Button disable/enable
let [message, setMessage] = useState("");      // Textarea ke liye message
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    <div className="card m-2 p-3">
                        ...
                        <button data-bs-toggle="modal"  className='btn btn-info btn-sm'>Contact Owner</button>
                    </div>
                </div>
            </div>
