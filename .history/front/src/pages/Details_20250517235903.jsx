  ...
  return (
    <>
      ...
      <Modal show={showMsg} onHide={()=>setShowMsg(false)}>
        ...
        <Modal.Body>
          <textarea onChange={(e)=>setMsg(e.target.value)} className='form-control ' placeholder='Type a Message to Owner'></textarea>
        </Modal.Body>

        <Modal.Footer>
          <Button variant='danger' onClick={()=>setShowMsg(false)}>X</Button>
          <Button disabled variant='success' onClick={sendMsg}>Send</Button>
        </Modal.Footer>
