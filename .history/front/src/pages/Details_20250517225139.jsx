...
const Details = () => {
  const [show, setShow] = useState(false); // For login warning modal
  const [showMsg, setShowMsg] = useState(false); // For message modal
          ...
          <div className="col-md-4">
            <div className="card m-2 p-3">
              ...
              <p><b>Ow-Contact:</b> +91 {localStorage.getItem("access-token") ? ownernum : '930XxXxXxX'}</p>
              {
                ...
                ?
                <button className='btn bg-green text-light btn-sm'>Connect With Owner</button>
                :
