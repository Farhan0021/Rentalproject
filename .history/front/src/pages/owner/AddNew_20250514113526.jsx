         ...
         <div className="col-md-9">
           ...
           <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="my-4">
              <label>Title</label>
              <input name='title' onChange={propFrm.handleChange} type='text' placeholder='Title' className={'form-control ' + (propFrm.errors.tittle && propFrm.touched.tittle ? 'is-invalid' : '')} />
              </div>
