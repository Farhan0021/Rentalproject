           ...
           <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="my-4">
                ...
                &nbsp;&nbsp;WiFi <input type='checkbox' name='amenity' onChange={propFrm.handleChange} />
                &nbsp;&nbsp;Electricity <input type='checkbox' name='amenity' onChange={propFrm.handleChange} />
                &nbsp;&nbsp;Water <input type='checkbox' name='amenity' onChange={propFrm.handleChange}/>
                &nbsp;&nbsp;Furnished <input type='checkbox' name='amenity' onChange={propFrm.handleChange} />
              </div>
