           ...
           <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="my-4">
                ...
                <input name='advance_money' onChange={propFrm.handleChange} type='text' placeholder='ADVANCE MONEY' className={'form-control ' + (propFrm.errors.rent && propFrm.touched.tittle ? 'is-invalid' : '')} />
              </div>
