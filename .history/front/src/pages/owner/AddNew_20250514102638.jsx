         ...
         <div className="col-md-9">
           ...
           <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="my-4">
              <label>Title</label>
              <input name='tittle' onChange={propFrm.handleChange} type='text' placeholder='Title' className={'form-control ' + (propFrm.errors.title && propFrm.touched.tittle ? 'is-invalid' : '')} />
              </div>
