...
const AddNew = () => {
  let propFrm = useFormik({
    ...
    onSubmit : (FormData)=>{
      axios.post(`${import.meta.env.VITE_API_URL}/property`)
    }
  })
  return (
         ...
         <div className="col-md-9">
           ...
           <div className="row">
            <div className="col-md-8 offset-md-2">
              ...
              <div className="my-4">
              <label>Title</label>
              <input name='title' onChange={propFrm.handleChange} type='text' placeholder='Title' className={'form-control ' + (propFrm.errors.title && propFrm.touched.tittle ? 'is-invalid' : '')} />
              </div>
